...
import { ArrowLeft, Copy, Check, Bell, Shield, User, MessageSquare, Eye, EyeOff, Save, AlertCircle, CheckCircle, Loader2 } from 'lucide-react'
              ...
              <div className="bg-white border border-gray-200 p-8 space-y-8">
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    {/* Birthday */}
                    <div>
                      <label className="block text-sm font-bold text-black uppercase tracking-wide mb-2">BIRTHDAY</label>
                      <input
                        type="date"
                ...
                <div className="pt-8 border-t border-gray-200">
                  <h3 className="text-xl font-bold text-black uppercase tracking-wide mb-4">BUSINESS INFORMATION</h3>
                  
                  <div className="space-y-4">
                    {/* NIPT ID Display */}
                    {user?.niptId && (
                      <div>
                        <label className="block text-sm font-bold text-black uppercase tracking-wide mb-2">NIPT ID</label>
                        <div className="px-4 py-3 border border-gray-300 bg-gray-50 rounded-none">
                          <p className="font-bold text-black">{user.niptId}</p>
                        </div>
                      </div>
                    )}
                    ...
                    {user?.taxId && (
                      <div>
                        <label className="block text-sm font-bold text-black uppercase tracking-wide mb-2">TAX ID</label>
                        <div className="px-4 py-3 border border-gray-300 bg-gray-50 rounded-none">
                          <p className="font-bold text-black">{user.taxId}</p>
                        </div>
                      </div>
                    )}

                    {/* Support Message */}
                    {(user?.niptId || user?.taxId) && (
                      <div className="p-4 border-l-4 border-blue-600 bg-blue-50">
                        <p className="text-sm font-semibold text-blue-800">ℹ️ Need to Update?</p>
                        <p className="text-xs text-blue-700 mt-2">If you need to update your NIPT ID or Tax information, please contact our support team at support@treigo.com</p>
                      </div>
                    )}
                  </div>
                </div>
                            ...
                            <div className="flex gap-2 items-start">
                              <div className="flex-1">
                                <input
                                  ...
                                  placeholder="e.g., seller_store, professional_seller"
              ...
              <div className="bg-white border border-gray-200 p-8">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      {[
                        { key: 'emailChatMessages', label: 'NEW MESSAGES', description: 'Get notified when customers message you' },
                        { key: 'emailOrderUpdates', label: 'ORDER UPDATES', description: 'Receive updates on your orders' },
                        { key: 'emailReviewRequests', label: 'REVIEW REQUESTS', description: 'Get notified of new reviews' },
                        { key: 'emailSecurityAlerts', label: 'SECURITY ALERTS', description: 'Important account security notifications' },
